...
urlpatterns = [
    ...
    url(r'^new/(?P<xxx>[0-9]+)/$', views.add_job, name='new'),

    url(r'^jobs/take/$', views.take_job, name='take_job'),
    ...
    url(r'^download/(?P<resource_id>[0-9a-f]*)/$', views.download, name='download'),
