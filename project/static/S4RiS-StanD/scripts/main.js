    ...
    this.goNext = function () {
        ...
        if (this.flashActive) {
            ...
            if (this.curRunInfo.solved) {
                getRow(curRow).find('.problem').filter('#' + this.pName + '').find('.problem-result').animate({backgroundColor: '#5cb85c'}, 100);
                ...
                getRow(curRow).find('.problem').filter('#' + this.pName + '').find('.problem-result').animate({backgroundColor: '#d9534f'}, 100);
                ...
                if ((runInfo.nTries > 0 || runInfo.solved) && !runInfo.defrost && runInfo.lastSubmitTime >= this.limit) {
                    ...
                    var object = {
                        func: function () {
                            ...
                            elem.animate({backgroundColor: '#f0ad4e'}, 400);
                        }
                    }
