...
class StudentProblemResult(object):
    def __init__(self, shortname, complexity, points, maxpoints):
...
def standings(request):
    ...
    for student in STUDENTS:
        ...
        for _ in range(6):
            ...
            maxpoints = rnd.randint(1, 100)
            points = rnd.randint(0, maxpoints)

            sprs.append(StudentProblemResult(problem[0], problem[1], points, maxpoints))

        tokens = student.split(' ')
        surname, name = tokens[0], tokens[1]
        insubgroup = (len(tokens) == 3)
        sr = StudentResult(name, surname, insubgroup, sprs)
        results.append(sr)

    context = {'results': results}
    return render(request, 'demo/standings.html', context)
