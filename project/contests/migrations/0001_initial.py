    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problem', models.ForeignKey(related_name='link_to_contest', to='problems.Problem', on_delete=django.db.models.deletion.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contest', models.ForeignKey(to='contests.Contest', on_delete=django.db.models.deletion.CASCADE)),
                ('user', models.ForeignKey(related_name='contestmembership', to=settings.AUTH_USER_MODEL, on_delete=django.db.models.deletion.CASCADE)),
            ],
        ),
        migrations.AddField(
            model_name='contest',
