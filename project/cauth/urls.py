...
urlpatterns = [
    ...
    url(r'^logout/$', default_views.LogoutView.as_view(), name='logout'),
    url(r'^profile/change-name/$', views.EditNameView.as_view(), name='name_change'),
    url(r'^profile/change-password/$', overridden_views.PasswordChangeView.as_view(), name='password_change'),
    url(r'^profile/change-password/done/$', default_views.PasswordChangeDoneView.as_view(), name='password_change_done'),
    ...
    url(r'^', include(two_factor_urlpatterns)),
]
